...
Sample runs of `brand-launchpad` across different brand types. All names,
numbers, and outputs in these examples are illustrative.

| File | Brand type | Use this if you're building... |
|------|-----------|--------------------------------|
...
The full skill produces 12 files per run; these examples show the
high-leverage outputs only.
